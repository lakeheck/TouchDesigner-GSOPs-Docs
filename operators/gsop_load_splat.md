...
Its parameters mirror the per-splat fields documented under [gsop_splat_scene](gsop_splat_scene.md) (Gaussian splat PLY, Reload, SPZ, T, R, Uniform Scale, Cam Preset Index). See that page for descriptions.
